package com.zen.boot.elasticjob;
...
@Configuration
@ConditionalOnClass(ElasticJobAutoConfig.class)
@Slf4j
public class ElasticJobAutoConfig implements BeanPostProcessor, EnvironmentAware,ApplicationContextAware {
        ...
        if (bean instanceof ElasticJob) {
            ...
            for (Annotation annotation : beanAnnotation) {
                if (annotation instanceof ElasticJobConfig) {
                    ElasticJobConfig simpleJobConfig = (ElasticJobConfig) annotation;
